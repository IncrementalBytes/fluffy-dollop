...
public class SignInActivity extends BaseActivity {
  ...
  private void onAuthenticateSuccess() {
    ...
    if (mAuth.getCurrentUser() != null && mAccount != null) {
      ...
      File localFile = new File(getFilesDir(), BaseActivity.DEFAULT_SERIES_FILE);
      String appDataPath = PathUtils.combine(BaseActivity.REMOTE_PATH, BaseActivity.DEFAULT_SERIES_FILE);
