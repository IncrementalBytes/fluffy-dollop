...
public class CameraSource {
  ...
  private Camera createCamera() throws IOException {
    ...
    parameters.setPreviewFpsRange(previewFpsRange[Parameters.PREVIEW_FPS_MIN_INDEX], previewFpsRange[Parameters.PREVIEW_FPS_MAX_INDEX]);
  ...
  private void setPreviewAndPictureSize(Camera camera, Parameters parameters) throws IOException {
    ...
    PreferenceUtils.saveStringPreference(context, R.string.pref_key_rear_camera_preview_size, previewSize.toString());

    Size pictureSize = sizePair.picture;
    if (pictureSize != null) {
      Log.d(TAG, "Camera picture size: " + pictureSize);
